 ...
 function hideElement(el, focusEl) {
  ...
  const CONFIGURATION = {
    ...
    "pois": [
      {"placeId": "ChIJWbrReBxawokRmMicGgsIrMA"},
      {"placeId": "ChIJBbqTpbBQwokRagvP-6KCTfM"},
      {"placeId": "ChIJy8jTDBtawokRuFkJI_8AmuI"},
      {"placeId": "ChIJ9-FOdxtawokRqsxMeFMTGSo"},
      {"placeId": "ChIJR6nWeq9QwokRpkeN8zc9CJY"},
      {"placeId": "ChIJia9F8KtQwokR3bwbALwPf6o"},
      {"placeId": "ChIJUXN88bNQwokRmBdAmCZYsgE"},
      {"placeId": "ChIJESx1K0xXwokRAYzFCO3vnSg"},
      {"placeId": "ChIJ018DSVRXwokRcqtZ-szPnIE"},
      {"placeId": "ChIJHSilR7JQwokREj7LWSKfqMY"},
      {"placeId": "ChIJsXA3ia9QwokRh2Ak3MHFCuw"},
      {"placeId": "ChIJe-5PkbFQwokRMMFMVnIYkYs"},
      {"placeId": "ChIJ_wQyRK5QwokR6MbXIGtAmAA"},
      {"placeId": "ChIJuZYHr0tXwokRTX4J_TWY3B8"},
      {"placeId": "ChIJJQ-DyDBXwokRDVrLo0JoO_Y"},
      {"placeId": "ChIJe2sa6K5QwokRuJHE4N8xlGg"},
      {"placeId": "ChIJPQzxXVNXwokRa07XAdUcBLo"},
      {"placeId": "ChIJOWVTySJawokRBoW1r7qh-Us"}
    ],
    "mapRadius": 2500,
    "mapOptions": {"center":{"lat":40.7177545,"lng":-74.0431435},"fullscreenControl":true,"mapTypeControl":true,"streetViewControl":false,"zoom":16,"zoomControl":true,"maxZoom":20},
    "mapsApiKey": "AIzaSyCfbugDucSh8KEOxroIGdsCxg2F1mnQm0U"
  };
